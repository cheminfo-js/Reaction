 ...
 * reaction
 * @version v0.0.0
 * @link https://github.com/cheminfo/reaction#readme
 * @license MIT
 */
...
class Reaction {
    constructor(data, options) {
        ...
        var _options$catPrefix = options.catPrefix,
            catPrefix = _options$catPrefix === undefined ? false : _options$catPrefix,
            _options$font = options.font,
            font = _options$font === undefined ? {
            family: 'Helvetica',
            anchor: 'middle',
            size: 15
        } : _options$font,
    ...
    static fromRXN(reactionRXN, options) {
        return Reaction.fromJSON((0, _utils.getFormat)(reactionRXN), options);
    }
    ...
    toSVG() {
        ...
        var data = (0, _utils.organizeData)(this.data, this.catPrefix, this.OCL);
        var context = (0, _svg2.default)(this.domElement);
...
function draw(context, data, font) {
    ...
    reagentsGroup.dmove(startingBox.width / 2.0 + reagentsBox.width / 2.0 + config.DISTANCE, startingBox.cy - reagentsBox.cy - reagentsBox.height / 2.0 - config.DISTANCE);
...
var _rxnParser = __webpack_require__(2);

var _rxnParser2 = _interopRequireDefault(_rxnParser);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function getFormat(rxnData, OCL) {
    var _parse = (0, _rxnParser2.default)(rxnData),
        reagents = _parse.reagents,
        products = _parse.products;
...
function organizeData(data, catPrefix, OCL) {
